...
- [x] 17 占領と日本国憲法（8枚）: 農地改革グラフ流用＋codex6＋憲法三原則図(image-2)・QA済み・**コミット済(8f9397e)**。
- [x] 18 冷戦と日本の復興（20枚）: 冷戦の東西陣営マップ=**実データで作り直し済**(cold_war・西側青/東側赤/凡例)／GNPグラフ=流用(石油危機ラベルのみ薄い不備だがイラスト豊富で許容)／codexシーン18枚を2バッチ生成中(bh13tl38g=9, b6ep2y0k1=9)／JSON配線済。
- [x] 19 現代の世界（11枚）: codex11・コミット済(4092bc5)。
- [x] 01 年代の表し方（3枚・図解2＋干支）／02 古代の世界（16枚・四大文明マップ流用）／03 日本の始まり（9枚）: 完成。

## ★★ 全19章コンプリート（2026-07-22）★★ 全章の節画像を用意・QA済み・コミット済。地図/図/グラフの欠陥は白村江/元寇/新航路/開港地/二大陣営/満州/冷戦マップ・帝国憲法図/日清風刺画/有権者グラフ 等を実データ・image-2・matplotlibで作り直した。
